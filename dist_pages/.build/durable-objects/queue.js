...
// node_modules/.pnpm/@opennextjs+cloudflare@1.16.2_next@16.1.6_react-dom@19.1.0_react@19.1.0__react@19.1.0_sass@1.97.3__wrangler@4.61.1/node_modules/@opennextjs/cloudflare/dist/api/durable-objects/queue.js
...
var DOQueueHandler = class extends DurableObject {
    ...
    try {
      ...
      response = await this.service.fetch(`${protocol}://${host}${url}`, {
        ...
        headers: {
          ...
          "x-prerender-revalidate": "a79e34f3fc447b499a46ff7a89c84499",
          "x-isr": "1"
        },
  ...
  async addToFailedState(msg) {
    ...
    if (!this.disableSQLite) {
      this.sql.exec("INSERT OR REPLACE INTO failed_state (id, data, buildId) VALUES (?, ?, ?)", msg.MessageDeduplicationId, JSON.stringify(updatedFailedState), "NSZMx_6fLaVkEUezMKQfZ");
    }
    await this.addAlarm();
  }
  async addAlarm() {
  ...
  async initState() {
    ...
    this.sql.exec("DELETE FROM failed_state WHERE buildId != ?", "NSZMx_6fLaVkEUezMKQfZ");
    this.sql.exec("DELETE FROM sync WHERE buildId != ?", "NSZMx_6fLaVkEUezMKQfZ");
