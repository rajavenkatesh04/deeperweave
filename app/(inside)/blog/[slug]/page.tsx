...
export default async function BlogPostPage({ params }: { params: Promise<{ slug: string }> }) {
    ...
    return (
        <article className="min-h-screen bg-white dark:bg-zinc-900">
            ...
            <div className="relative w-full h-[70vh] min-h-[500px] max-h-[800px] overflow-hidden">
                {post.banner_url ? (
                    <>
                        ...
                        {/* Bottom fade effect */}
                        <div className="absolute bottom-0 left-0 w-full h-1/3 bg-gradient-to-t from-white dark:from-zinc-900 to-transparent z-2"></div>
                    </>
                ) : (
                ...
                <header className="relative z-10 container mx-auto px-4 h-full flex flex-col justify-center items-center text-center pt-20">
                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 max-w-4xl leading-tight">
                        {post.title}
                    </h1>

                    <div className="mt-6 flex items-center justify-center gap-4 bg-black/20 backdrop-blur-sm rounded-full py-2 px-4">
            ...
            {/* Main content container - removed rounded background */}
            <div className="relative mt-12 max-w-4xl mx-auto px-4 md:px-6 -mt-24 z-10">
                {/* Article Content */}
                <div
                ...
                {/* Movie Info Card moved to bottom */}
                ...
                {/* Engagement metrics */}
                <div className="mt-8 pt-6 border-t border-gray-200 dark:border-zinc-700 flex items-center justify-between">
