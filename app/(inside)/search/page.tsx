...
function SearchContent() {
    ...
    const initialQuery = searchParams.get('query') || ''; // ✨ Extract '?query=...'
    ...
    // Run search when query changes (including initial load from URL)
    useEffect(() => {
        // Immediate search if loaded from URL, otherwise debounce
    ...
    }, [query]); // Removed 'initialQuery' from deps to avoid double loops
...
/* --- 4. Main Page Wrapper (Suspense Required) --- */
