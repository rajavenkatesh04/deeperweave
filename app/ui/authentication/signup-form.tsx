        ...
        <div className="min-h-screen flex items-center justify-center p-4 bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 relative">
            ...
            <div className="w-full max-w-5xl">
                ...
                <div className="grid md:grid-cols-2 bg-white dark:bg-black border border-zinc-200 dark:border-zinc-800 shadow-sm md:shadow-2xl overflow-hidden">
                    ...
                    <div className="hidden md:flex flex-col items-center justify-center bg-zinc-50 dark:bg-zinc-900/30 p-12 border-r border-zinc-200 dark:border-zinc-800 relative overflow-hidden">
                        {/* Subtle Grid Pattern */}
                        ...
                        <div className="relative z-10 text-center space-y-8 max-w-sm">
                            <div className="mx-auto w-40 h-40 flex items-center justify-center rounded-full bg-gradient-to-br from-amber-100 to-orange-100 dark:from-amber-900/20 dark:to-orange-900/20 border border-orange-200/50 dark:border-orange-800/30">
                                <SparklesIcon className="w-20 h-20 text-orange-500/80" />
                            </div>

                            <div className="space-y-4">
                                <h2 className={`${PlayWriteNewZealandFont.className} text-4xl font-bold text-zinc-800 dark:text-zinc-200`}>
                                    Act One.
                                </h2>
                    ...
                    <div className="p-8 md:p-12 lg:p-16 flex flex-col justify-center">
                        ...
                        {/* Mobile Header: "Act One" Visual (Visible only on mobile) */}
                        <div className="md:hidden mb-10 text-center border-b border-zinc-100 dark:border-zinc-800 pb-8">
                            <div className="mx-auto w-16 h-16 flex items-center justify-center rounded-full bg-orange-50 dark:bg-orange-900/10 mb-4">
                                <SparklesIcon className="w-8 h-8 text-orange-500" />
                            </div>
                            <h2 className={`${PlayWriteNewZealandFont.className} text-3xl font-bold text-zinc-800 dark:text-zinc-200 mb-2`}>
                                Act One.
                            </h2>
                        ...
                        <div className="mb-10 text-center md:text-left">
                            <Link href="/" className="inline-block mb-6 md:hidden">
                                <span className={`${PlayWriteNewZealandFont.className} text-2xl font-bold tracking-tight`}>
                                    Deeper Weave
                                </span>
                            </Link>
