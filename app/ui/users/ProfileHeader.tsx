                ...
                <div className="flex flex-col gap-8 lg:flex-row lg:items-center">
                    ...
                    <div className="flex-1 text-center sm:text-left">
                        ...
                        <div className="mt-4 flex items-center justify-center sm:justify-start gap-6 text-sm">
                            <div><span className="font-bold text-gray-800 dark:text-zinc-200">{followerCount}</span> <span className="text-gray-500 dark:text-zinc-400">Followers</span></div>
                            <div><span className="font-bold text-gray-800 dark:text-zinc-200">{followingCount}</span> <span className="text-gray-500 dark:text-zinc-400">Following</span></div>
                        </div>
                    </div>
