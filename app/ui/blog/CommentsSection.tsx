...
export default function CommentsSection({
    ...
    // Reverse the comments array to show most recent first
                ...
                <form ref={formRef} action={formAction} className="mt-6 flex items-start gap-4 p-4 rounded-xl bg-white/70 dark:bg-zinc-900/70 backdrop-blur-md border border-white/30 dark:border-zinc-700/30 shadow-sm">
                    ...
                    <div className="flex-1">
                        <textarea
                            ...
                            className="w-full rounded-xl border border-gray-300/70 bg-white/50 p-4 shadow-sm backdrop-blur-sm dark:border-zinc-700/50 dark:bg-zinc-800/50 focus:ring-2 focus:ring-gray-400/30 dark:focus:ring-zinc-600/30"
                            required
                        ></textarea>
