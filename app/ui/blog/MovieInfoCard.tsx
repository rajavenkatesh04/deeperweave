        ...
        <>
            ...
            <div className="my-6 relative">
                ...
                <div className="mb-3 flex items-center justify-center">
                    <div className="flex items-center gap-2 rounded-full bg-gradient-to-r from-blue-50 to-indigo-50 px-3 py-1.5 shadow-sm ring-1 ring-blue-100/50 dark:from-blue-950/40 dark:to-indigo-950/40 dark:ring-blue-800/30">
